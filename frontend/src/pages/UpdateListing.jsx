            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                {formData.type === 'rent' && (
                  <span className='text-xs'>($ / month)</span>
                    ...
                    {formData.offer && 
                        <div className='flex items-center gap-2'>
                        <input onChange={handleChange} value={formData.discountedPrice} className='p-3 border border-gray-300 rounded-lg ' type='number' id='discountedPrice' min="0" max="1000000" required />
                        <div className='flex flex-col items-center'>
