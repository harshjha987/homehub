...
function CreateListing() {
    ...
    const handleImageSubmit = (e)=>{
      if(files.length>0 && files.length + formData.imageUrls.length<7){
        ...
        setImageUploadError("You can only Upload 6 pages per listing ")
        setUploading(false);
      }
    }
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6'>
                    ...
                    <div className='flex items-center gap-2'>
                        <input className='p-3 border border-gray-300 rounded-lg ' type='number' id='baths' min="1" max="10" required />
                        <p>Baths</p>
                        
                    </div>
                    <div className='flex items-center gap-2'>
                        <input className='p-3 border border-gray-300 rounded-lg ' type='number' id='regular' min="1" max="10" required />
            ...
            <div className='flex gap-4'>
             ...
             }} className='p-3 border border-gray-300 rounded w-full' type='file' id='images' accept='images/*' multiple />
